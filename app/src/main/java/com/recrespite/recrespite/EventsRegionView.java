     ...
     * this class populates teh listview for all the regions in select region screen
     * sends get request to regions API
     */
    public class EventsRegionView extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_events_region_view);
    ...
    //                url.put(jsonObject.getString("name"),jsonObject.getString("articlePDF"));
                ...
                listViewLib.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position,
                        ...
                        Intent intent = new Intent(EventsRegionView.this,EmptyLib.class);
                        String title=((TextView)view).getText().toString();
                        //Toast.makeText(Library.this,title,Toast.LENGTH_SHORT).show();
                       // String pdf=url.get(((TextView) view).getText().toString());
                        intent.putExtra("region",((TextView) view).getText().toString());
